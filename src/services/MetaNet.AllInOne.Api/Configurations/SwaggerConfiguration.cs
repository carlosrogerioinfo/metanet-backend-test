    ...
    public static class SwaggerConfiguration
    {
        public static IServiceCollection AddSwaggerConfiguration(this IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "MetaNet Backend - Simple PDV Web Api",
                    Description = "Api de PDV simplificado do projeto MetaNet Backend",
                    Version = "v1",
                    Contact = new OpenApiContact
                    {
                        Name = "MetaNet Backend Web Api",
                        Email = "carlosrogerio.info@gmail.com",
                        Url = new Uri("https://github.com/carlosrogerioinfo/metanet-microservices")
                    },
                    License = new OpenApiLicense
                    {
                        Name = "Licença de uso: MetaNet Backend Web Api",
                        Url = new Uri("https://github.com/carlosrogerioinfo/metanet-microservices")
                    }
                });
